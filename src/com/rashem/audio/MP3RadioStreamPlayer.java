...
import com.rashem.doppler.MainActivity;
        ...
        if (true){//asdf.var15 == 1) {
            ...
            while (!sawOutputEOS && noOutputCounter < noOutputCounterLimit && !doStop) {
                ...
                if (res >= 0) {
                    ...
                    double bias_factor = 0.01 * asdf.orig_rate / asdf.oldfinalrate;//0.01
                    asdf.var3 = asdf.var3 * (1-bias_factor) + bias_factor * (asdf.orig_rate / 2 + ((asdf.orig_rate * asdf.lastnonzerok)/ (2.0 * asdf.convertedtargetspeed)));
                    ...
                    if (asdf.var3 > asdf.orig_rate+asdf.orig_rate / 2) {
                        asdf.var3 = asdf.orig_rate+asdf.orig_rate / 2;
